...
function display_login_form($msg = '')
{
    ...
    <div id="login">
        ...
        <?php if (isset($_GET['message'])) {
             echo '<div id="error"><b>Session expired!!</b></div>';
            }?>
        <?php
                  ...
                  while ($row = mysqli_fetch_assoc($songs)) {
                   ...
                   ?>
                      <div id="song-card" data-index="<?php echo $index;?>">
                          ...
                          <audio id="audio<?php echo $index;?>" preload="none" data-musid="<?php echo $row['_id'];?>"></audio>
                      </div>
                      <?php
                  }
                }
            }else{
                setcookie("search", $searchQuery, time() + 3600);
